...
[UnitOrder(3)]
[UnitTitle("On BB Check")]
[TypeIcon(typeof(Update))]
public sealed class OnBBCheck : MachineEventUnit<UpdateArguments>
{
	protected override string hookName => Constants.EventTriggers.onBBCheck;
